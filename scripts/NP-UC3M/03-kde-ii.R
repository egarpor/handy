...
## ---- kde-3d, eval = knitr:::is_html_output(), cache = TRUE, eval = FALSE--------------
...
## ---- level-set-6a, eval = knitr:::is_html_output(), cache = TRUE, eval = FALSE--------
...
## ---- level-set-6b, eval = knitr:::is_html_output(), cache = TRUE, eval = FALSE--------
