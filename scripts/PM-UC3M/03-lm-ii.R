...
## -----------------------------------------------------------------------------
## Name: 03-lm-ii.R
## Description: Script for Chapter 3 of "Predictive Modeling"
...
# joint model, plus the specific terms associated with `chas`
...
# Coefficients associated with the principal components -- same as in modPCA3
