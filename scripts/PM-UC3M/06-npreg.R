...
## -----------------------------------------------------------------------------
## Name: 06-npreg.R
## Description: Script for Chapter 6 of "Predictive Modeling"
...
## ----ks-3d, eval = knitr:::is_html_output(), eval = FALSE---------------------
...
# The asymptotic standard error associated with the regression evaluated at the
